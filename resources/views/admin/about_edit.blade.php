        ...
        <script>
            $(document).ready(function() {
                ...
                $(add_button).click(function(e) {
                    e.preventDefault();
                    $(wrapper).append(
                        '<div><input class="form-control" style="margin: 5px 0" type="text" name="core_values[]"/><a href="#" class="delete" style="position: absolute;right: 0;margin-top: -51px;padding: 4px 10px;background: red;color: white;font-size: 25px;border-radius: 5px;">x</a></div>'
                        ); //add input box
                });
        ...
        <script>
            $(document).ready(function() {
                ...
                $(add_button).click(function(e) {
                    e.preventDefault();
                    $(wrapper).append(
                        '<div><input class="form-control" style="margin: 5px 0" type="text" name="goals[]"/><a href="#" class="delete" style="position: absolute;right: 0;margin-top: -51px;padding: 4px 10px;background: red;color: white;font-size: 25px;border-radius: 5px;">x</a></div>'
                        ); //add input box
                });
                $(wrapper).on("click", ".delete", function(e) {
                    e.preventDefault();
        ...
        <script>
            $(document).ready(function() {
                ...
                $(add_button).click(function(e) {
                    e.preventDefault();
                    $(wrapper).append(
                        '<div><input class="form-control" style="margin: 5px 0" type="text" name="code_of_conduct[]"/><a href="#" class="delete" style="position: absolute;right: 0;margin-top: -51px;padding: 4px 10px;background: red;color: white;font-size: 25px;border-radius: 5px;">x</a></div>'
                        ); //add input box
                });
                $(wrapper).on("click", ".delete", function(e) {
                    e.preventDefault();
