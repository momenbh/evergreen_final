...
<!-- Mirrored from designreset.com/cork/ltr/demo4/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 Jul 2022 06:54:39 GMT -->
...
<head>
    ...
    <link href="{{ url('admin/plugins/file-upload/file-upload-with-preview.min.css') }}" rel="stylesheet"
        type="text/css" />
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="index.html">
                        <img src="{{ url('admin/assets/img/logo.svg') }}" class="navbar-logo" alt="logo">
                    </a>
                </li>
                <li class="nav-item theme-text">
                    <a href="index.html" class="nav-link"> Evergreen </a>
                </li>
            </ul>
            ...
            <ul class="navbar-item flex-row ml-md-auto">
                ...
                <li class="nav-item dropdown user-profile-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                        ...
                        <img src="{{ url('admin/assets/img/profile-16.jpg') }}" alt="avatar">
                    </a>
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        <div class="">
                            ...
                            <div class="dropdown-item">
                                <a class="" href="{{route('admin.login')}}"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="#Reviews" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <ul class="collapse submenu list-unstyled" id="Reviews" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('client.reviews')}}"> Add </a>
                            </li>
                            <li>
                                <a href="{{route('manage.client')}}"> Manage </a>
                            </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="News" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('add.category')}}"> Category Add </a>
                            </li>
                            <li>
                                <a href="{{route('manage.category')}}"> Category Manage </a>
                            </li>
                            <li>
                                <a href="{{route('add.news')}}"> News Add </a>
                            </li>
                            <li>
                                <a href="{{route('news.manage')}}"> News Manage </a>
                            </li>
